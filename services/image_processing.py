...
def create_quote_image(quote: Quote, bg_path: str | None) -> Image:
    ...
    height: float = (len(quote.quote) * 1.12 - 0.12) * quote.font.max_height
    # TODO: get rid of the hard code numbers
    y: float = (quote_image.height - height) / 2 + quote.font.max_height * 0.5
